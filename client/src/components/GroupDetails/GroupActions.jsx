...
const GroupActions = ({ isEditing, setIsEditing, handleUpdateGroup, handleDeleteGroup }) => (
  <div className="flex space-x-4 mt-4">
    ...
    <button
      ...
      className="px-4 py-2 bg-muted-light dark:bg-muted-dark text-red-500 dark:text-red-400 hover:text-red-600 rounded-lg hover:bg-muted-light/70 dark:hover:bg-muted-dark/70 transition"
    >
      Delete
    </button>
  </div>
