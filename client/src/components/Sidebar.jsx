      ...
      >
        ...
        <div className="relative">
          <input
            ...
            className="w-full font-mono px-3 py-2 rounded-xl bg-muted-light dark:bg-muted-dark text-sm text-text-light dark:text-text-dark border border-border-dark dark:border-border-light focus:outline-none focus:ring-2 focus:ring-primary"
          />
